...
/***/ function(module, exports, __webpack_require__) {
	...
	//获得格式化的string ,以"【名称】 原因 + \r\n"
	MyValidation.prototype.toFormatStr = function (result) {
		let str = "";
      ...
      for(let i=0,len=value.length;i<len;i++){
      	...
      	if(!value[i].result){
          let title = value[i].object.showName;
          let failMessage = value[i].failMessage;
          let msg = "【"+title+"】"+" "+ failMessage+" \r\n";
          str = str.concat(msg);
				}
      }
		}
